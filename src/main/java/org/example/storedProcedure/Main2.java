/*
    Code to demonstrate how to execute storedProcedure (not a named storedProcedure)
...
public class Main2 {
    public static void main(String[] args) {
        ...
        StoredProcedureQuery storedProcedure = entityManager2.createStoredProcedureQuery("GetDepartmentEmployeeInfo");

        // register the parameter that means do the parameter mapping
        storedProcedure.registerStoredProcedureParameter("departmentName", String.class, ParameterMode.IN);
        storedProcedure.registerStoredProcedureParameter("employeeCount", Integer.class, ParameterMode.OUT);
        ...
        // it will return list of object[]. The array will hold the details of employee
        List<Object[]> employees = storedProcedure.getResultList();
        for(Object[] employee : employees) {
            BigInteger id = (BigInteger) employee[0];
